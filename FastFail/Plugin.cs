...
namespace FastFail
{
    ...
    public class Plugin
    {
        ...
        // public const string HarmonyId = "com.github.YourGitHub.FastFail";
        // internal static HarmonyInstance harmony => HarmonyInstance.Create(HarmonyId);

        internal static Plugin instance { get; private set; }
        internal static string Name => "FastFail";
        internal static FastFailController PluginController { get { return FastFailController.instance; } }
        ...
        */
        ...
        {
            new GameObject("FastFailController").AddComponent<FastFailController>();
            //ApplyHarmonyPatches();
        }
